...
HD_PWD='/home/josecoelho/Documents/IST/PSD/Labs/Lab3/psd-proj3/Lab3.runs/train_classes_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log train_classes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source train_classes.tcl
